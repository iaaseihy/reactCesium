...
!(function (e, t) {
  ...
  function x(e) {
    ...
    var n = (function (e, t) {
      var r = (function (e, t) {
        ...
        n = (function (e, t) {
          var r =
            2 * e - 100 + 3 * t + 0.2 * t * t + 0.1 * e * t + 0.2 * p(B(e));
          return (
            (r += (2 * (20 * b(6 * e * D) + 20 * b(2 * e * D))) / 3),
  ...
  function J(e, t) {
    return 72.004 <= e && e <= 137.8347 && 0.8293 <= t && t <= 55.8271;
  }
  var k = Math.sin,
    L = Math.cos,
    j = Math.atan2,
  ...
  function N(e) {
    var t = e[0],
      ...
      n = I(t * t + r * r) + 2e-5 * k(r * q),
      o = j(r, t) + 3e-6 * L(t * q);
    return [n * L(o) + 0.0065, n * k(o) + 0.006];
  }
  var O = 180 / Math.PI,
    A = Math.PI / 180,
    F = 6378137,
  ...
  function z(e) {
    return [
      (e[0] * O) / F,
      (0.5 * Math.PI - 2 * Math.atan(Math.exp(-e[1] / F))) * O,
    ];
  }

  function T(e) {
    var t = Math.abs(e[0]) <= 180 ? e[0] : e[0] - 360 * (e[0] < 0 ? -1 : 1),
      r = [F * t * A, F * Math.log(Math.tan(0.25 * Math.PI + 0.5 * e[1] * A))];
    return (
      r[0] > _ && (r[0] = _),
      r[0] < -_ && (r[0] = -_),
      r[1] > _ && (r[1] = _),
  ...
  function ae(e, t, r) {
    ...
    if (
      ("string" != a &&
        "object" != a &&
        m("coordinate must be an geojson or an array of position"),
        "string" == a)
    )
      try {
        e = JSON.parse(e);
    ...
    var i = !1;
    S(e) &&
      (e.length < 2 && m("position must be at 2 numbers long"),
        (G(e[0]) && G(e[1])) || m("position must contain numbers"),
        (e = e.map(Number)),
        (i = !0));
    var u = o;
    return i
      ...
      : ((function e(t, r, n) {
        if ((void 0 === n && (n = !1), null !== t))
          for (
            ...
            d = "Feature" === h,
            G = v ? t.features.length : 1,
            S = 0;
            S < G;
            S++
          ) {
            f = (l =
              !!(s = v ? t.features[S].geometry : d ? t.geometry : t) &&
              "GeometryCollection" === s.type)
              ? s.geometries.length
              : 1;
            for (var P = 0; P < f; P++) {
              var b = 0,
              ...
              if (null !== (u = l ? s.geometries[P] : s)) {
                ...
                switch (
                ((M =
                  !n || ("Polygon" !== p && "MultiPolygon" !== p) ? 0 : 1),
                  p)
                ) {
                  case null:
                    break;
